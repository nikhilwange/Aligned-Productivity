        ...
        <div className="glass-card rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="block text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider ml-1">New password</label>
              <input
                required
                type="password"
                value={password}
            ...
            <div className="space-y-2">
              <label className="block text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider ml-1">Confirm password</label>
              <input
                required
                type="password"
