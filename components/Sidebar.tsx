      ...
      <div className="pt-8 px-5 mb-6">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className={`w-full py-3.5 px-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2.5 text-sm ${activeId === 'actions' && !isLiveActive
