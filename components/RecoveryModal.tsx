  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-[var(--surface-900)] border border-white/[0.08] shadow-2xl overflow-hidden animate-fade-in">
        ...
        <div className="p-6">
          {/* Icon */}
          <div className="w-14 h-14 mx-auto mb-5 rounded-2xl bg-gradient-to-br from-amber-500/20 to-purple-500/20 border border-white/[0.08] flex items-center justify-center">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onRecover}
              className="flex-1 px-4 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-teal-600 hover:from-purple-500 hover:to-teal-500 text-sm font-bold text-white transition-all active:scale-95 shadow-lg shadow-purple-500/20"
            >
              Recover
            </button>
          </div>
